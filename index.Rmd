...
1. Learning and doing more with R (4:50)
---
...
You can access all of the workshop materials at: https://github.com/bretsw/fsu-workshop/

```{r, out.width = "720px", echo = FALSE, fig.align = "center"}
knitr::include_graphics("img/download_repo_screenshot.png")
```
